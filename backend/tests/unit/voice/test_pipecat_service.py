...
class TestPipecatService:
    ...
    async def test_vad_integration(self):
        ...
        assert service.pipeline is not None, "Pipeline should be initialized"
        assert service.user_aggregator is not None, (
            "User aggregator should be initialized"
        )
        assert service.assistant_aggregator is not None, (
            "Assistant aggregator should be initialized"
        )
    ...
    async def test_transcription_integration(self):
        ...
        assert service.pipeline is not None, "Pipeline should be initialized"
        assert service.transcription_processor is not None, (
            "Transcription processor should be initialized"
        )
