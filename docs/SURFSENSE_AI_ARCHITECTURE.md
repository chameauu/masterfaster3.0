# SurfSense AI Architecture: RAG, Indexing & LLM Integration

> Deep dive into SurfSense's AI-powered backend: Retrieval-Augmented Generation, document indexing, podcast generation, and LLM orchestration with LiteLLM.
...
SurfSense is a **Retrieval-Augmented Generation (RAG) platform** that combines:
...
class ComposioConnector(BaseConnector):
    ...
    4. Index via SurfSense pipeline
    """
...
- [Composio Integration](https://composio.dev/docs/)
