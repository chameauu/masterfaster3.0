...
import { voiceConversationAtom, voiceSessionAtom, voiceUIAtom } from "@/atoms/voice";
import { VoiceAPIError, voiceSearch } from "@/lib/apis/voice-api";
	...
	return (
		<div className="flex flex-col items-center gap-8 p-8 max-w-4xl mx-auto">
			...
			<div className="text-center space-y-2">
				...
				<p className="text-muted-foreground">Search your documents using voice commands</p>
			</div>
